...
class OAuthTokenServiceTest {
    ...
    void save_shouldUpdateExistingToken() {
        ...
        when(tokenRepository.findByUserIdAndService(1L, StreamingPlatform.SPOTIFY))
    ...
    void save_shouldCreateNewToken() {
        when(tokenRepository.findByUserIdAndService(2L, StreamingPlatform.YOUTUBE))
    ...
    void getValidAccessTokenDto_shouldReturnDtoIfValid() {
        ...
        when(tokenRepository.findByUserIdAndService(1L, StreamingPlatform.SOUNDCLOUD))
